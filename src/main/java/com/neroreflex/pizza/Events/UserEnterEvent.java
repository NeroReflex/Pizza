...
/**
 * Rappresenta un evento di ingresso di un utente in
 * un canale al quale il bot si e' unito.
 *
 * @author Benato Denis
 */
public class UserEnterEvent extends Event {

    public UserEnterEvent(String ... eInfo) {
        super(eInfo);

        this.type = EventType.UserEnter;
    }
}
